...
#include <sawIntuitiveResearchKit/system_configuration_t.h>
...
class CISST_EXPORT mtsIntuitiveResearchKitConsole: public mtsTaskFromSignal
{
 ...
 public:
    ...
    class CISST_EXPORT console_t {
    public:
        friend class mtsIntuitiveResearchKitConsole;

        std::string m_name;
        mtsIntuitiveResearchKitConsole * m_console = nullptr;
        dvrk::console_proxy_configuration_t * m_config = nullptr;

        console_t(const std::string & name,
                  mtsIntuitiveResearchKitConsole * console,
                  dvrk::console_proxy_configuration_t * config);

        NOT_COPYABLE(console_t);
        NOT_MOVEABLE(console_t);
 ...
 protected:
    dvrk::system_configuration_t m_config;
    bool m_configured;
