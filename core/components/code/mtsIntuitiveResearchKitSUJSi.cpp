...
void mtsIntuitiveResearchKitSUJSi::set_simulation_mode(const prmSimulationType & mode)
{
    ...
    case prmSimulationType::KINEMATIC:
        break;
    default:
        cmnThrow("mtsIntuitiveResearchKitSUJSi::set_simulation_mode received unsupported mode");
    }
